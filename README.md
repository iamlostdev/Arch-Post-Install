run this file via bash filename ; if you dont want to have your cpu compile the packages run the chaotic-aur.sh file as root and swap paru -S packages for sudo pacman -S packages;
